...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Đồng bộ hóa dữ liệu sản phẩm mẫu
        System.out.println("⏳ Đang đồng bộ hóa dữ liệu sản phẩm với tài nguyên CDN thực tế...");
        createOrUpdateSampleProducts();
        System.out.println("✅ Hoàn tất đồng bộ hóa: " + productRepository.count() + " sản phẩm.");

        // Khởi tạo hệ thống Voucher
        if (voucherRepository.count() == 0) {
            createSampleVouchers();
            System.out.println("✅ Khởi tạo hệ thống Voucher thành công.");
        }
    ...
    private void createOrUpdateSampleProducts() {
        ...
        saveOrUpdateProduct("Áo Thun Nam Cotton Compact", "Cotton Compact chống nhăn, thoáng mát",
                ...
                "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?auto=format&fit=crop&w=800&q=80", true,
                true);
        ...
        saveOrUpdateProduct("Áo Polo Nam Quick Dry", "Áo polo thể thao nam Quick Dry Active",
                ...
                "https://images.unsplash.com/photo-1625910513413-5fc7144e40ef?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Áo Khoác Bomber Thể Thao", "Áo khoác bomber nam phong cách sporty",
                ...
                "https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&w=800&q=80", true,
                false);
        ...
        saveOrUpdateProduct("Quần Jean Nam Slim Fit", "Quần jean nam dáng slim fit trẻ trung",
                ...
                "https://images.unsplash.com/photo-1542272604-787c3835535d?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Váy Nữ Hoa Nhí Spring", "Họa tiết hoa nhí phong cách Hàn Quốc",
                ...
                "https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&w=800&q=80", true,
                false);
        ...
        saveOrUpdateProduct("Áo Blazer Công Sở Nữ", "Áo blazer nữ thiết kế thanh lịch",
                ...
                "https://images.unsplash.com/photo-1591369822096-ffd140ec948f?auto=format&fit=crop&w=800&q=80", false,
                false);
        ...
        saveOrUpdateProduct("Đầm Dạ Hội Cut-out", "Đầm dạ hội thiết kế cut-out tinh tế",
                ...
                "https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Áo Thun Nữ Basic", "Áo thun nữ basic cotton 100% mềm mại",
                ...
                "https://images.unsplash.com/photo-1521577352947-9bb58764b69a?auto=format&fit=crop&w=800&q=80", true,
                true);
        ...
        saveOrUpdateProduct("Quần Jean Nữ Ống Rộng", "Quần jean nữ ống rộng phong cách Y2K",
                ...
                "https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Áo Sơ Mi Học Sinh Nam Túi Bên DPT001",
                ...
                "https://images.unsplash.com/photo-1598033129183-c4f50c736f10?auto=format&fit=crop&w=800&q=80", true,
                true);
        ...
        saveOrUpdateProduct("Quần Tây Học Sinh Nam Xanh Đen TDP011", "Quần tây phom chuẩn quai rẽ lịch sự",
                ...
                "https://images.unsplash.com/photo-1473966968600-fa801b869a1a?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Quần Short Học Sinh Nam TDP002", "Lưng thun thoải mái cho bé vận động",
                ...
                "https://images.unsplash.com/photo-1506629082955-511b1aa562c8?auto=format&fit=crop&w=800&q=80", false,
                false);

        // ==================== DANH MỤC SCHOOL - BÉ GÁI ====================
        saveOrUpdateProduct("Bộ Áo Dài Học Sinh Trắng Tinh GDP061", "Thiết kế chuẩn truyền thống, tôn dáng duyên dáng",
                new BigDecimal("339000"), new BigDecimal("450000"), 25, "SCHOOL", "JADINY",
                "https://images.unsplash.com/photo-1594938298603-c8148c4dae35?auto=format&fit=crop&w=800&q=80", true,
                true);
        ...
        saveOrUpdateProduct("Áo Sơ Mi Nữ Học Sinh Bèo Ngực GDP001", "Điểm nhấn bèo nhún dọc cổ áo nữ tính",
                ...
                "https://images.unsplash.com/photo-1604695573706-53170668f6a6?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Chân Váy Học Sinh Nữ Xếp Ly GDP065", "Vải tuyết mưa không nhăn, xếp ly chuẩn đẹp",
                ...
                "https://images.unsplash.com/photo-1582142306909-195724d33ffc?auto=format&fit=crop&w=800&q=80", false,
                true);

        // ==================== UNISEX / PE ====================
        saveOrUpdateProduct("Quần Thể Dục Học Sinh 3 Sọc TDP025", "Vải thun co giãn tốt, thoải mái cho tiết học PE",
                new BigDecimal("120000"), new BigDecimal("160000"), 25, "SCHOOL", "JADINY",
                "https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?auto=format&fit=crop&w=800&q=80", false,
                false);
        ...
        saveOrUpdateProduct("Váy Bé Gái Công Chúa Hồng", "Váy bé gái thiết kế công chúa màu hồng",
                ...
                "https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?auto=format&fit=crop&w=800&q=80", true,
                true);
        ...
        saveOrUpdateProduct("Đầm Bé Gái Hoa Nhí", "Đầm bé gái họa tiết hoa nhí xinh xắn",
                ...
                "https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?auto=format&fit=crop&w=800&q=80", false,
                false);
        ...
        saveOrUpdateProduct("Áo Thun Bé Gái Hoạt Hình", "Áo thun bé gái in hình hoạt hình dễ thương",
                ...
                "https://images.unsplash.com/photo-1622290291468-a28f7a7dc6a8?auto=format&fit=crop&w=800&q=80", true,
                false);
        ...
        saveOrUpdateProduct("Áo Thun Bé Trai Siêu Nhân", "Áo thun bé trai in hình siêu nhân Marvel",
                ...
                "https://images.unsplash.com/photo-1519238263530-99bdd11df2ea?auto=format&fit=crop&w=800&q=80", true,
                true);
        ...
        saveOrUpdateProduct("Quần Short Bé Trai Thể Thao", "Quần short bé trai thể thao năng động",
                ...
                "https://images.unsplash.com/photo-1503919545889-aef636e10ad4?auto=format&fit=crop&w=800&q=80", false,
                true);
        ...
        saveOrUpdateProduct("Áo Polo Bé Trai Lịch Sự", "Áo polo bé trai phong cách lịch sự",
                ...
                "https://images.unsplash.com/photo-1503944583220-79d8926ad5e2?auto=format&fit=crop&w=800&q=80", true,
                false);
        ...
        saveOrUpdateProduct("Áo Khoác Bé Trai Bomber", "Áo khoác bomber bé trai phong cách, giữ ấm tốt",
                ...
                "https://images.unsplash.com/photo-1516627145497-ae6968895b74?auto=format&fit=crop&w=800&q=80", false,
                true);
    }
    ...
    private void createSampleReviews() {
        ...
        if (products.size() > 0) {
            ...
            createReview(p, testUser, 5,
                    "Sản phẩm rất đẹp, chất lượng tốt. Giao hàng nhanh, đóng gói cẩn thận. Rất hài lòng!", true);
            createReview(p, reviewer1, 4, "Chất vải mềm mại, form đẹp. Chỉ tiếc là màu hơi khác so với hình một chút.",
                    true);
            createReview(p, reviewer2, 5, "Mặc rất thoải mái, giá cả hợp lý. Sẽ ủng hộ shop dài dài.", false);
        }

        // Review cho sản phẩm thứ hai
        if (products.size() > 1) {
            Product p = products.get(1);
            createReview(p, reviewer1, 5, "Váy đẹp lắm, mặc lên rất xinh. Chất liệu thoáng mát, phù hợp mùa hè.", true);
        ...
        if (products.size() > 4) {
            ...
            createReview(p, testUser, 5, "Áo khoác denim đẹp, phong cách Hàn Quốc. Chất vải dày dặn.", true);
